    ...
    $(document).ready(function () {
        ...
        var cursor = $(".mt-cursor"),
            ...
            document.addEventListener('DOMContentLoaded', () => {
                // Add event listeners to all anchor links with the 'smooth-scroll' class
                ...
                smoothScrollLinks.forEach(link => {
                    ...
                    if (targetElement) {
                        ...
                        // Optionally: Use Sharp.js for additional functionality (if integrated)
                        // Example: sharp(targetElement).scroll();
                    }
                    });
                });
                });
